...
public class AdvisorCompletedController implements Initializable {
    ...
    @FXML
    private Label lbl_completed_courses;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        lbl_completed_courses.setText(facade.printCompletedCourses());
    }
